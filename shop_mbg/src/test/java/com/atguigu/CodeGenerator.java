...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("D:\\javase\\workspace\\guli_shop\\code\\shop_parent\\shop_mbg\\src\\main\\java");
        globalConfig.setAuthor("xiejl");
        //生成后是否打开资源管理器
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/shop_order?serverTimezone=GMT%2B8");
